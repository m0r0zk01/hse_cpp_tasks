...
TEST_CASE("SortStudents") {
    for (TestData test : TESTS) {
        ...
        //static int cnt = 0;
        //std::cout << '\n' << cnt++ << '\n';
        //for (auto& s : test.students) {
        //    std::cout << s.name << ' ' << s.last_name << ' ' << s.birth_date.year << ' ' << s.birth_date.month << ' ' << s.birth_date.day << '\n';
        //}
        //std::cout << int(test.sort_kind) << '\n';
        //for (auto& s : test.result) {
        //    std::cout << s.name << ' ' << s.last_name << ' ' << s.birth_date.year << ' ' << s.birth_date.month << ' ' << s.birth_date.day << '\n';
        //}
